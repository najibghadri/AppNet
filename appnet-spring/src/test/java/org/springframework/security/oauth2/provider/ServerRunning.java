...
public class ServerRunning implements MethodRule, RestTemplateHolder {
	...
	public Statement apply(final Statement base, FrameworkMethod method, Object target) {
		...
		try {
			client.getForEntity(new UriTemplate(getUrl("/appnet/login.jsp")).toString(), String.class);
			online = true;
		...
		postForStatus(savedClient, "/appnet/oauth/uncache_approvals", new LinkedMultiValueMap<String, String>());
		...
		return new Statement() {
			...
			public void evaluate() throws Throwable {
				try {
					...
					postForStatus(savedClient, "/appnet/oauth/cache_approvals",
